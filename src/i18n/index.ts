...
export const fr = {
  ...
  trialReminderHow: "Pour continuer après l'essai, payez sur le site OUAQT avec votre numéro de série.",
  payOnSite: "Payer sur le site",
  dismissToday: "Fermer",
  trialEndedTitle: "Votre essai est terminé",
  licenceEndedTitle: "Votre licence a pris fin",
  endedBody:
    "Tout ce que vous avez enregistré reste ici : vous pouvez le consulter et l'exporter. Pour vendre à nouveau, payez sur le site OUAQT avec votre numéro de série.",
...
export const ar: Copy = {
  ...
  trialReminderHow: "لتواصل بعد التجربة، ادفع على موقع OUAQT برقمك التسلسلي.",
  payOnSite: "الدفع على الموقع",
  dismissToday: "إغلاق",
  trialEndedTitle: "انتهت تجربتك",
  licenceEndedTitle: "انتهت رخصتك",
  endedBody:
    "كل ما سجلته يبقى هنا: يمكنك الاطلاع عليه وتصديره. لتبيع من جديد، ادفع على موقع OUAQT برقمك التسلسلي.",
...
export const en: Copy = {
  ...
  trialReminderHow: "To carry on after the trial, pay on the OUAQT website with your serial number.",
  payOnSite: "Pay on the website",
  dismissToday: "Close",
  trialEndedTitle: "Your trial has ended",
  licenceEndedTitle: "Your licence has ended",
  endedBody:
    "Everything you recorded stays here: you can look at it and export it. To sell again, pay on the OUAQT website with your serial number.",
